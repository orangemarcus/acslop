      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-cream-300 p-5 shadow-soft">
            <h3 className="text-xs font-semibold text-warm-600 uppercase tracking-wider mb-3 flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-terracotta-500" />
              Original Text
            </h3>
            <p className="text-warm-700 text-sm leading-relaxed font-serif italic">{result.original}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-cream-300 p-5 shadow-soft">
            <h3 className="text-xs font-semibold text-warm-600 uppercase tracking-wider mb-3 flex items-center gap-2">
              ...
              Plain English
              <span className="text-[10px] font-normal normal-case text-warm-600 tracking-normal">(hover highlighted phrases for original jargon)</span>
            </h3>
